...
measurement and data type inference", available 
at https://content.iospress.com/articles/data-science/ds240062.

Enhanced with a twist: Incorporates Bayesian prior in dialect scoring for improved accuracy.
...
class sniffer:
    ...
    delimiter_list : List[str]
        List of delimiters to be considered in dialect detection.
    quotechar_list : List[str]
        List of escape characters to be considered in dialect detection.
    encoding : str
